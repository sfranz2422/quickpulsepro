"""
Django settings for quickpulsepro project.
...
ROOT_URLCONF = 'quickpulsepro.urls'
...
WSGI_APPLICATION = 'quickpulsepro.wsgi.application'
...
if DATABASE_URL:
    # Render, or anywhere else that supplies a DATABASE_URL.
    DATABASES = {
    ...
    # Local development: fall back to a SQLite file in the project folder.
    DATABASES = {
        "default": {
            "ENGINE": "django.db.backends.sqlite3",
            "NAME": BASE_DIR / "db.sqlite3",
